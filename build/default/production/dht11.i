...
# 134 "./BBSPI_LCD.h"
    ...
    void printLCD_string(int line , char *array);
    void printLCD_char (int line , char position , char c);
# 15 "./dht11.h" 2
...
char getByte() {
    ...
    for(j = 0; j < 8; j++){
        ...
        _delay((unsigned long)((30)*(10000000/4000000.0)));
        if(!PORTDbits.RD0 & 1)
            i&= ~(1<<(7 - j));
        else {
            i|= (1 << (7 - j));
...
char readDHT() {
    ...
    LATDbits.LATD0 = 1;
    _delay((unsigned long)((20)*(10000000/4000000.0)));
    TRISDbits.TRISD0 = 1;
...
void get_temp_humid(void) {
    if (state == ON)
    {
        ...
        if (humidity_value>46) turn_fan3 = 1;
        else turn_fan3 = 0;
